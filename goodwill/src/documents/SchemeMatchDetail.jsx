...
const SchemeMatchDetail = () => {
  ...
  const scheme = {
    ...
    description: 'A central sector scheme to support traditional artisans and craftspeople through skill upgrading, toolkit incentives, and collateral-free credit support.',
    benefit: 'Up to ₹15,000 toolkits + ₹500/day training stipend + up to ₹3 Lakh collateral-free loan.',
    ...
    aiReasoning: 'Strong match. Your profile indicates you are an artisan in Maharashtra. The ₹15,000 toolkit grant directly impacts your stated income bracket. Act quickly, as the deadline is approaching.'
  };
  ...
  return (
    <div className="sm-detail-container">
      ...
      <main className="sm-detail-main">
        {/* Back Navigation */}
        <button className="sm-btn-back">
          <span className="sm-arrow-left" >←</span><Link className='back' to="/dashboard"> Back to Dashboard</Link>
        </button>
            ...
            <div className="sm-sticky-card">
              ...
              <div className="sm-score-block">
                ...
                <div className="sm-score-display">
                  {scheme.impactScore}<span className="sm-score-max">/100</span>
                </div>
                <div className="sm-progress-track">
                  <div className="sm-progress-fill" style={{ width: `${scheme.impactScore}%` }}></div>
                </div>
