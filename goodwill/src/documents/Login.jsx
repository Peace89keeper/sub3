...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const simulatedResponse = { data: { token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.dummy.token" } };
      ...
      <main className="sm-login-main">
        <div className="sm-login-wrapper">
          ...
          <div className="sm-login-footer">
            <p>Don't have an account? <span className="sm-link-highlight">Build your profile</span></p>
          </div>
        </div>
      </main>
    </div>
